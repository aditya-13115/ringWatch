    ...
    <div className="max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Convert messy raw addresses into canonical entities
        </p>
      </div>
      ...
      {result && (
        <Card className="p-4 mt-6">
          ...
          <dl className="space-y-2 text-sm">
            <div><dt className="text-muted-foreground">Raw Address</dt><dd>{result.raw_address}</dd></div>
            <div><dt className="text-muted-foreground">Normalized Address</dt><dd>{result.normalized_address}</dd></div>
            <div><dt className="text-muted-foreground">Canonical Address ID</dt><dd>{result.candidate_address_id || "Not resolved"}</dd></div>
            <div><dt className="text-muted-foreground">Confidence</dt><dd>{(result.confidence * 100).toFixed(0)}%</dd></div>
            <div>
